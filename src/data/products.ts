...
export const PRODUCTS: Product[] = [
  {
    ...
    materialsAndCare: {
      composition: '100% Poliester (mrežica)',
  ...
  },
  {
    ...
    storySr: 'Inspirisana bojama Jonskog mora i letnjim zalascima sunca, haljina "Larisa" je stvorena za žene koje žele da zablistaju bez napora.',
    features: [
    ...
    materialsAndCare: {
      composition: '100% Prirodna tkanina, pamuk',
      origin: 'Ručno šiveno u Ateljeu Jelena Erić, Topola',
      care: [
        'Pranje u mašini na 30°C',
        'Peglati sa naličja',
  ...
  },
  {
    ...
    materialsAndCare: {
      composition: '50% Viskoza 50% Poliester (Žersej)',
      origin: 'Ručno šiveno u Ateljeu Jelena Erić, Topola',
      care: [
        'Pranje u mašini na 30°C',
        'Peglati sa naličja',
  ...
  },
  {
    ...
    materialsAndCare: {
      composition: '50% Viskoza 50% Poliester',
      origin: 'Ručno šiveno u Ateljeu Jelena Erić, Topola',
      care: [
        'Pranje u mašini na 30°C',
        'Peglati sa naličja',
  ...
  },
  {
    id: 'jullyet-top',
    nameSr: 'Top "Jullyet"',
    subtitleSr: 'Bezrukava top sa leopard dezenom i tilom',
    category: 'majice',
    categoryLabelSr: 'Majice',
    priceRSD: 4490,
    badge: 'LIMITED EDITION',
    ...
    features: [
      ...
      'Bezrukavni kroj za letnje dane'
    ],
    materialsAndCare: {
      composition: 'Pamučni saten + til',
      origin: 'Ručno šiveno u Ateljeu Jelena Erić, Topola',
      care: [
        'Pranje u mašini na 30°C',
        'Peglati sa naličja',
  ...
  },
  {
    ...
    nameSr: 'Crvena asimetrična haljina "Linda"',
    ...
    storySr: 'Dizajnirana za žene koje ne boje da budu u centru pažnje. "Linda" spaja odvažan asimetričan kroj sa senzualnošću crvene boje, kreirajući haljinu koja govori pre nego što vi progovorite.',
    features: [
    ...
    materialsAndCare: {
      composition: '100% Prirodna pamuk',
      origin: 'Ručno šiveno u Ateljeu Jelena Erić, Topola',
      care: [
        'Pranje u mašini na 30°C',
        'Peglati sa naličja',
  ...
  },
  {
    ...
    features: [
      ...
      'Izrađena od kvalitetnih materijala',
  ...
  {
    id: 'crna-asimetricna',
    nameSr: 'Crna asimetrična haljina "Linda"',
  ...
  },
  {
    ...
    category: 'haljine',
    categoryLabelSr: 'Letnja haljine',
    priceRSD: 9990,
    badge: 'Novo',
  ...
  },
  {
    ...
    materialsAndCare: {
      composition: '100% viskoza (žersej)',
      origin: 'Ručno šiveno u Ateljeu Jelena Erić, Topola',
      care: [
        'Pranje u mašini na 30°C',
        'Peglati sa naličja',
  ...
  },
  {
    ...
    subtitleSr: 'Boje i geometrija u jednoj priči',
    category: 'haljine',
    categoryLabelSr: 'Haljine',
    priceRSD: 10490,
    badge: 'UNIKAT',
