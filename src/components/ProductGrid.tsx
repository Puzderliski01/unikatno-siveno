  ...
  return (
    <section id="kolekcija" className="py-20 bg-[#FCFBF7] text-[#1A1A1A] relative border-b border-[#C5A059]/20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-[#F4F1EA] border border-[#C5A059]/30 rounded-none p-4 mb-10 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2 overflow-x-auto w-full md:w-auto pb-2 md:pb-0 scrollbar-none">
            {categories.map((cat) => (
              <button
                ...
                className={`px-4 py-2 text-xs font-sans uppercase tracking-[0.15em] transition-all whitespace-nowrap ${
        ...
        <div className="mt-16 p-8 sm:p-10 bg-[#1A1A1A] text-[#FCFBF7] border border-[#C5A059]/40 relative overflow-hidden flex flex-col md:flex-row items-center justify-between gap-6 shadow-xl">
          ...
          <button
            ...
            className="relative z-10 flex-shrink-0 px-8 py-4 bg-[#C5A059] hover:bg-[#A7823B] text-black font-semibold text-xs uppercase tracking-[0.2em] transition-all duration-300 flex items-center gap-2 group shadow-md"
          >
